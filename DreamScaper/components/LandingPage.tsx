...
export const LandingPage: React.FC<{ onLaunchApp: () => void }> = ({ onLaunchApp }) => (
  <div className="flex flex-col min-h-screen">
    ...
    <section className="bg-emerald-950 text-white pt-24 pb-36 text-center px-4">
      ...
      <button onClick={onLaunchApp} className="px-10 py-5 bg-emerald-500 text-white font-black text-xl rounded-2xl shadow-2xl flex items-center justify-center gap-3 mx-auto transition-transform hover:scale-105 active:scale-95">
